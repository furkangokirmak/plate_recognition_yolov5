...
def recognize_plate_easyocr(img, coords,reader,region_threshold):
    ...
    result = ocr.ocr(nplate, cls=True)
    result = result[0]
...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('', 'custom', source ='local', path='best.pt',force_reload=True) ### The repo is stored locally
...
#main(vid_path="./resimler/vid_1.mp4",vid_out="vid_3.mp4") ### for custom video
#main(vid_path=0,vid_out="webcam_facemask_result.mp4") #### for webcam

for i in range(1,24):
    main(img_path="./img/test_images/" + str(i) + ".jpg") ## for image
